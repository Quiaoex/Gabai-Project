...
${noteText}</textarea
      ...
      <div class="noteaction">
        <button><i class="fa fa-floppy-o savebutton" id="savebtn"></i></button>
...
${element.text}</textarea>
      ...
      <div class="noteaction">
      <button><i class="fa fa-floppy-o savebutton" id="${
          index + 1
        }" onclick="saveNote(this.id)"></i></button>
  ...
  if (notesObj.length != 0) {
    ...
    row.innerHTML = `<h4>No Notes Yet! Please add a note. <img src="pencil.png" width="50"/></h4>`;
  }
}
