        ...
        <nav id="sidebarMenu" class="col-md-1 col-lg-1 d-md-block sidebar" style="padding-left: 5px; padding-bottom:350px; background-color: #E0B894;">
            <div class="sidebar py-3" id="sidebar">
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                  <li class="nav-item">
                    <a href="./user-homepage.html" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Calendar" data-bs-original-title="Calendar">
                      <img src="./Images/calendar.png" alt="mdo" width="40" height="40" class="ewan">
                      <h6>My Planner</h6>
                    </a>
                  </li>
                  <li>
                    <a href="./user-notes.html" class="nav-link  active py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Notes" data-bs-original-title="Notes">
                      <img src="./Images/notes.png" alt="mdo" width="40" height="40" class="ewan">
                      <h6>Notes</h6>
                    </a>
                  </li>
                  <li>
                    <a href="./user-classes.html " class="nav-link py-3 border-bottom rounded-0" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Classes" data-bs-original-title="Classes">
