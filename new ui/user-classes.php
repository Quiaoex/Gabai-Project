        ...
        <nav id="sidebarMenu" class="col-md-1 col-lg-1 d-md-block sidebar" style="padding-left: 5px; padding-bottom:350px; background-color:#959595">
            <div class="sidebar py-3" id="sidebar">
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                  ...
                  <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="./Classes.html" style="color:white; font-size: 17px; ;">
          ...
          <main class="mt-3 mb-3" style="background-color:white ;">
            <div class="row" style="height: 700px;">
               ...
               <div class="col">
                ...
                <div class="event1" style="border-color: #959595; background-color: #959595; height: 630px;">
                    <p class="text-center text-muted" style="margin-right: 10%; margin-top: -5%;">Note title</p>     
                    <div class="mb-3">
                      <label for="exampleFormControlTextarea1" class="form-label"></label>
                      <textarea class="form-control" placeholder="Content here"  id="exampleFormControlTextarea1" rows="20" style="margin-left: -6%; background-color: #959595; border-color: #959595;"></textarea>
                    </div>
