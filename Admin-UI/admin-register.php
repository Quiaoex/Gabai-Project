                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" name="registration">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid "><button class="btn btn-block" style=" background-color: #542C0C; color: white;"name="register" type="submit" value="Create Account">Register</button></div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="admin-login.php" style="color: #542C0C;">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
